...
## 1. /* plots for assumptions */

* Sorting may be required for histograms and qqplots.;
proc sort data = dataset;
    by explanatory;
run;
proc print data = dataset;
...
* proc univariate can plot both histograms and qqplots;
...
* Can also use proc ttest just for histograms (with boxplots) and qqplots;
* generate histograms and qqplots;
proc ttest data = dataset;
class explanatory;
var response;
run;

* Histograms using PROC UNIVARIATE to adjust to same scale;
proc univariate data=dataset noprint;
    by explanatory;
    histogram response / endpoints=0 to 1000 by 50 normal;  * Adjust the range and bin width as needed;
...
* get difference of means (needed for permutation comparison);
...
proc iml;                                                                                                                                                                                                                    
use data;                        * change data set name here to match your data set name above;                                                                                                                              
read all var{group variable} into x;   *change variable names here ... make sure it is class then var ... in that order.;                                                                                                  
...
set diff;                                                                                                                                                                                                                    
where method = "Pooled";                                                                                                                                                                                                     
if abs(mean) >= abs(diffOfMeans);   *you will need to put the observed difference you got from t test above here.  note if you have a one or two tailed test.;                                                                           
run;                                                                                                                                                                                                                         
