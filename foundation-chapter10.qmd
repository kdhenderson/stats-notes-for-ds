...
![**Boxplot showing variation in corrosion measurements at each iron content level, used in assessing model fit.**](images/fch10_ironcor_fitplot_SAS.png){width=5in fig-align="center"}

![**Fit plot with 95% confidence and prediction intervals for the linear regression model of corrosion versus iron content.**](images/fch10_ironcor_boxplot_SAS.png){width=5in fig-align="center"}
