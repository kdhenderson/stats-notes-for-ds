...
![**Scatterplot of test score vs. study hours with best-fit line.**](images/fch08_pearsonR.png)
...
![**Two-tailed *t*-test for slope coefficient.** The red line shows the observed test statistic ($t = 4.78$). Shaded regions represent the critical regions at $\alpha = 0.05$ for a two-tailed test with 11 degrees of freedom. The slope coefficient is statistically significant (*p*-value = 0.0006).](images/fch08_ttestSlope.png)
