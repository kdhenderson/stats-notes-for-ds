...
Bayes’ theorem can be extended for more than two classes.
...
- Works when logistic regression fails due to separation
...
- Cannot handle categorical predictors (because of the MVN assumption).
- No built-in feature selection.
- Suffers from the **curse of dimensionality** (i.e. will not predict well with too many unhelpful predictors).  
