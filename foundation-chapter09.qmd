...
|--------------------------------------|--------------------------------------|--------------------------------------|--------------------------------------|
| $\textcolor{#BB4444}{1}$             | $\textcolor{#BB4444}{(35 - 13)^2 = 100}$ | $\textcolor{#BB4444}{(37 - 13)^2 = 64}$  | $\textcolor{#BB4444}{(25 - 13)^2 = 36}$  |
...
|--------------------------------------|--------------------------------------|--------------------------------------|--------------------------------------|
| $\textcolor{#44AA55}{1}$             | $\textcolor{#44AA55}{(35 - 32.5)^2 = 6.25}$   | $\textcolor{#44AA55}{(37 - 32.5)^2 = 20.25}$ | $\textcolor{#44AA55}{(25 - 32.5)^2 = 56.25}$ |
...
The total variability in the response can be decomposed into variability explained by the regression model and variability due to error:

$$
R^2 = \frac{\text{SSR}}{\text{SST}} = 1 - \frac{\text{SSE}}{\text{SST}}
$$

The $R^2$ value quantifies how much of the total variability is explained by the regression model:
...
![](images/f_distribution_placeholder.png)

<div class="figure-caption">
<strong>F Distribution Under Null Hypothesis.</strong>
</div>

The F-test compares the variability explained by the regression model to the residual variability. A large value like $F = 106.47$ indicates the regression model provides a significantly better fit than the equal means model.

#### Hypothesis Test Conclusion

The $F$-statistic of 106.47 with a *p*-value < 0.0001 provides strong evidence to reject the null hypothesis that all group means are equal. The regression model explains a significant portion of the total variability in scores.
